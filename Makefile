.PHONY: help build-debug build-release format format-fix lint analysis test-unit test-integration contract schemas docs-smoke command-smoke resource-smoke verify clean
